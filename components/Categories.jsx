	...
	return (
		<div className="flex gap-5 px-6">
			...
			<div className="info flex flex-col justify-center py-4">
				...
				<div className="title">
					<Link href={`posts/${id}`}>
						<a className="text-slate-500 hover:text-[#5d9bbc] font-bold cursor-pointer transition duration-150 ease-in-out">
							{title || "Title"}
						</a>
					</Link>

					<Link href={`posts/${id}`}>
						<a className="text-slate-400 hover:text-[#5d9bbc] ml-2 text-xs cursor-pointer transition duration-150 ease-in-out">
							-{published || "unknown"}
						</a>
					</Link>
				</div>
